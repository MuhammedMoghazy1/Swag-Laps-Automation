...
public class TC04_CheckOutTest {
    ...
    public TC04_CheckOutTest() throws IOException {
    }
    ...
    public void checkOutStepTC() {
        ...
        Assert.assertTrue(
                Utility.verifyURL(getDriver(), checkoutOverviewURL),
                "Checkout Overview URL is incorrect"
        );
    }
